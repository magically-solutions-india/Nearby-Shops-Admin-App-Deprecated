package org.nearbyshops.serviceprovider.ShopApprovals.SlidingLayerSort;
...
//        String[] sort_options = UtilitySortShopItem.getSort(getActivity());
    ...
    void sortByNameClick(View view)
    {
        ...
        UtilitySortShops.saveSort(getActivity(),SORT_BY_DISTANCE);
    ...
    void sortByCreated(View view)
    {
        ...
        UtilitySortShops.saveSort(getActivity(),SORT_BY_RATING);
