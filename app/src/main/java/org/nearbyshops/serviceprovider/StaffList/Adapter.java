    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolderTripRequest) {
            ...
            if (fragment instanceof StaffListFragment) {
                itemCount = (((StaffListFragment) fragment).item_count_vehicle + 1 );
            }
...
//            itemCount = dataset.size();
    ...
    void bindTripRequest(ViewHolderTripRequest holder, int position)
    {
        if(dataset.get(position) instanceof User)
        {
            ...
            StaffPermissions permissions = tripRequest.getRt_staff_permissions();
            ...
            holder.designation.setText(permissions.getDesignation());
