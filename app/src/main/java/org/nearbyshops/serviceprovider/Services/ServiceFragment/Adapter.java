package org.nearbyshops.serviceprovider.Services.ServiceFragment;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType== VIEW_TYPE_SERVICE)
        {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_item_service_new,parent,false);
...
//                System.out.println("Service LOGO : " + imagePath);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.service_address) TextView serviceAddress;
        @BindView(R.id.city) TextView city;
        @BindView(R.id.helpline_number) TextView helplineNumber;
        @BindView(R.id.service_type) TextView serviceType;
        @BindView(R.id.service_range) TextView serviceRange;
        @BindView(R.id.rating) TextView rating;
        @BindView(R.id.rating_count) TextView ratingCount;
        @BindView(R.id.description) TextView description;
        @BindView(R.id.service_logo) ImageView serviceLogo;

        @BindView(R.id.is_official) TextView isOfficial;
        @BindView(R.id.is_verified) TextView isVerified;

        @BindView(R.id.tag_service_type) TextView tagServiceType;
